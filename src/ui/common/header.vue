<template>
  <div class="contentHeading">
    <div class="contentHeading__left">
      <svg v-if="false" version="1.1" id="Capa_1" x="0px" y="0px"
           width="22px" height="22px"
           viewBox="0 0 438.543 438.543"
           style="enable-background:new 0 0 438.543 438.543;fill: #cbdae4;"
           xml:space="preserve">
            <g>
